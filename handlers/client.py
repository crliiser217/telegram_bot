...
# Создание клиентских хэндлеров для чат-бота
...
# Отправка клиенту информацию по количеству голосов
